import { PrivateScanResultView, ReadinessView, ScanRequestView, ScanState } from "./types";
    ...
    <main class="shell">
      <section class="toolbar">
        <div>
          ...
          <p>Station ${view.stationId} secure scan request</p>
        </div>
        <div class="actions">
      ...
      <section class="readiness ${view.readiness.readerReady ? "ready" : "offline"}">
        ...
        <div class="value">${view.stationId} ${view.readiness.readerReady ? "Ready" : "Reader offline"}</div>
        <p>${readinessText(view.connected, view.readiness)}</p>
      </section>
      ${view.result ? resultHtml(view.result) : ""}
      <section class="status">
        <div class="label">Status</div>
        <div class="value">${view.justActivated ? "Your turn now" : view.state}</div>
