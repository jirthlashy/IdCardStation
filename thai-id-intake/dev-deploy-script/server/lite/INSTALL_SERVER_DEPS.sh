...
stage_runtime() {
  ...
  printf '%s\n' 'Generated by INSTALL_SERVER_DEPS.sh. Do not edit this runtime folder.' \
    > "$STAGE_DIR/backend/README.txt"
  printf '%s\n' 'Generated by INSTALL_SERVER_DEPS.sh. Do not edit this runtime folder.' \
    > "$STAGE_DIR/nurse-webapp/README.txt"
  printf '%s\n' 'Generated by INSTALL_SERVER_DEPS.sh. Do not edit this runtime folder.' \
    > "$STAGE_DIR/station-display/README.txt"
